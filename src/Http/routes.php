...
Route::group(['prefix' => Config::get("entrust-gui.route-prefix"), 'middleware' => Config::get("entrust-gui.middleware")], function () {
    ...
    Route::get('permissions/create', ['uses' => 'PermissionsController@create', 'as' => 'entrust-gui::permissions.create']);
    Route::post('permissions', ['uses' => 'PermissionsController@store', 'as' => 'entrust-gui::permissions.store']);
    Route::get('permissions/{id}/edit', ['uses' => 'PermissionsController@edit', 'as' => 'entrust-gui::permissions.edit']);
    Route::put('permissions/{id}', ['uses' => 'PermissionsController@update', 'as' => 'entrust-gui::permissions.update']);
    Route::delete('permissions/{id}', ['uses' => 'PermissionsController@destroy', 'as' => 'entrust-gui::permissions.destroy']);
    Route::get('permissions/{id}', ['uses' => 'PermissionsController@show', 'as' => 'entrust-gui::permissions.show']);
});
